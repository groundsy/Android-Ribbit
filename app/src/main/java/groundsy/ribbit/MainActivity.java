...
public class MainActivity extends FragmentActivity implements ActionBar.TabListener {
            ...
            switch (choice) {
                ...
                case 1: // Take video
                    ...
                    if (mMediaUri == null) {
                        ...
                        videoIntent.putExtra(MediaStore.EXTRA_VIDEO_QUALITY, 0);    // Set lowest res video
     ...
     * {@linkFragmentPagerAdapter} derivative, which will keep every
        ...
        if (resultCode == RESULT_OK) {
            if(requestCode == PICK_PHOTO_REQUEST || requestCode == PICK_VIDEO_REQUEST) {
                ...
                if (requestCode == PICK_VIDEO_REQUEST) {
                    // Check file size. must be less than 10 MB
                    int fileSize = 0;
                    ...
                    try {
                        ...
                        try {
                            ...
                            // catch input stream close error
                        }
                    }
